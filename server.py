...
class Server(object):
    ...
    * self.client_connection: a "connection" socket as produced by socket
    accept()
    ...
    * self.room: one of 0, 1, 2, 3. This signifies which "room" the client is in,
    ...
    def room_description(self, room_number):
        ...
        return ["You are in the room with the white dresser.",
            "You are in the room with the green sink.",
            "You are in the room with the purple wallpaper.",
            "You are in the room with the brown rug."][room_number]
    ...
    def get_input(self):
        ...
        This is a BLOCKING call. It should not return until there is
        some input from
